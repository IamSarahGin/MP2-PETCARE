...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchPendingBookings = async () => {
            try {
                const response = await axios.get('http://localhost:3001.com/api/bookings/pending', { withCredentials: true });
    ...
    const handleApproveBooking = async (bookingId) => {
        try {
            await axios.post('http://localhost:3001.com/api/bookings/approve', { bookingId }, { withCredentials: true });
    ...
    const handleRejectBooking = async (bookingId) => {
        try {
            await axios.post('http://localhost:3001.com/api/bookings/reject', { bookingId }, { withCredentials: true });
