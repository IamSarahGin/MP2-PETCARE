        ...
        try {
            ...
            if (selectedAction && selectedBookingId) {
                if (selectedAction.startsWith('approve')) {
                    await axios.post('http://localhost:3001.com/api/bookings/approve', { bookingId: selectedBookingId }, { withCredentials: true });
                    updatedStatus = 'Approved';
                } else if (selectedAction.startsWith('reject')) {
                    await axios.post('http://localhost:3001.com/api/bookings/reject', { bookingId: selectedBookingId }, { withCredentials: true });
