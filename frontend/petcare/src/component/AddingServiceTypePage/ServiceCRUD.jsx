...
const ServiceCRUD = () => {
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get('https://mp2-petcare.onrender.com/serviceTypes');
  ...
  const handleCreateService = async () => {
    try {
      await axios.post('https://mp2-petcare.onrender.com/services', { serviceType });
      setServiceType('');
      fetchServices();
    } catch (error) {
  ...
  const handleUpdateService = async () => {
    try {
      await axios.put(`https://mp2-petcare.onrender.com/service/${updateServiceId}`, { serviceType: updateServiceType });
  ...
  const handleDeleteService = async (serviceId) => {
    try {
      await axios.delete(`https://mp2-petcare.onrender.com/service/${serviceId}`);
      fetchServices();
    } catch (error) {
