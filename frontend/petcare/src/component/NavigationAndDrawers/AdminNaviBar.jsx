...
const AdminNaviBar = ({ isAdmin }) => {
    ...
    const fetchAuthStatus = async () => {
        try {
            const response = await axios.get('https://mp2-petcare.onrender.com/auth/status', { withCredentials: true });
            setLoggedIn(true);
        } catch (error) {
    ...
    const handleLogout = async () => {
        try {
            await axios.get('https://mp2-petcare.onrender.com/logout', { withCredentials: true });
            setLoggedIn(false);
