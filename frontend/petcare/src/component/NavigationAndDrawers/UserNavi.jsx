...
const UserNavi = () => {
    ...
    useEffect(() => {
        const fetchUserNavData = async () => {
            try {
                const response = await axios.get('https://mp2-petcare.onrender.com/user_navigation');
    ...
    useEffect(() => {
        axios.get('https://mp2-petcare.onrender.com/api/currentUserEmail', { withCredentials: true })
            .then(response => {
