...
const AppointmentList = () => {
  ...
  const fetchPendingBookings = async () => {
    try {
      const response = await axios.get('https://mp2-petcare.onrender.com/api/bookings/pending', {
  ...
  const updateBookingStatus = async (bookingId, newStatus) => {
    try {
      await axios.post(`https://mp2-petcare.onrender.com1/api/bookings/update-status/${bookingId}/${newStatus}`, {}, {
        withCredentials: true,
        headers: {
          'Content-Type': 'application/json'
        }
